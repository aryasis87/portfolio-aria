        ...
        <div className="mx-auto grid max-w-6xl gap-5">
          {posts.map((p, i) => (
            <Reveal key={p.title} delay={(i % 3) * 0.08}>
              <a href="/contact" className="group flex flex-col justify-between gap-4 rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl transition hover:bg-white/10 sm:flex-row sm:items-center md:p-8">
